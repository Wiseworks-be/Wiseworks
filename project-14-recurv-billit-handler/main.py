# MAIN.PY
# ************************************************************************************************
# THIS FLOW HANDLES TRANSACTIONS TO BILLIT
#
# params: no params
#
...
def main(request):
    ...
    # *********************************************************
    try:
        response = post_data_to_appsheet_whc_v2(
            table="fee_types", rows=[], action="Find", selector=selector
        )
    ...
    try:
        ...
        response = post_data_to_appsheet_whc_v2(
            table="actuals", rows=rows, action="Add", selector=None
        )
        # *********************************************************
    ...
    return (
        jsonify(
            {"project_id": project_id, "message": "TS were successfully processed"}
        ),
        200,
    )
